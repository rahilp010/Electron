   ...
   const filteredData = useMemo(() => {
      ...
      let result = products.filter((data) => {
         ...
         const matchesProduct = productFilter
            ? data.id === productFilter
            : true;

         const matchesAssetsType = assetsTypeFilter
            ? data.assetsType === assetsTypeFilter
            : true;
         ...
         return (
            matchesSearch && matchesProduct && matchesDate && matchesAssetsType
         );
      });
      return result;
                     ...
                     <table className="min-w-max border-collapse  table-fixed">
                        <thead className="bg-gray-200">
                           <tr className="text-sm sticky top-0">
                              ...
                              <th className="px-4 py-3  border-r border-gray-300 w-[250px]">
                                 Client
                              </th>
                              <th className="px-4 py-3  border-r border-gray-300 w-[250px]">
                                 Product
                        ...
                        <tbody className="text-sm divide-y divide-gray-200">
                           ...
                           {filteredData.map((product, index) => (
                              <tr
                                 ...
                                 <td
                                    className={`px-4 py-3 text-[#93DA97] font-bold`}>
