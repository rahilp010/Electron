                  ...
                  <div className="grid grid-cols-2 gap-4 my-2">
                     <div>
                        ...
                        <Input
                           ...
                           onChange={(value) =>
                              handleOnChangeEvent(value, 'clientName')
                           }
                     ...
                     <div>
                        ...
                        <Input
                           ...
                           onChange={(value) =>
                              handleOnChangeEvent(value, 'phoneNo')
                           }
                           className="w-full border border-gray-300 rounded px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-400 h-9 items-center tracking-wide"
                        />
                     </div>
                     <div className="mb-4">
                        ...
                        <InputNumber
                           ...
                           onChange={(value) =>
                              handleOnChangeEvent(value, 'pendingAmount')
                           }
                     ...
                     <div className="mb-4">
                        ...
                        <InputNumber
                           ...
                           onChange={(value) =>
                              handleOnChangeEvent(value, 'paidAmount')
                           }
                           formatter={toThousands}
                           className="w-full border border-gray-300 rounded px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-400"
                        />
                     ...
                     <div className="mb-4">
                        ...
                        <InputNumber
                           ...
                           onChange={(value) =>
                              handleOnChangeEvent(value, 'pendingFromOurs')
                           }
                           formatter={toThousands}
                           className="w-full border border-gray-300 rounded px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-400"
                        />
