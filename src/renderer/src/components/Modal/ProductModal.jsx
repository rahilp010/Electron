               ...
               <div className="bg-white p-6 rounded-lg shadow-2xl w-full max-w-lg relative">
                  ...
                  <div className="grid grid-cols-2 gap-4 my-2">
                     ...
                     <div>
                        ...
                        <SelectPicker
                           ...
                           onChange={(value) =>
                              handleOnChangeEvent(value, 'assetsType')
                           }
                     ...
                     <div>
                        ...
                        <Input
                           ...
                           value={product.name}
                           onChange={(value) =>
                              handleOnChangeEvent(value, 'name')
                           }
                  ...
                  <div className="mb-4">
                     ...
                     <InputNumber
                        ...
                        value={product.price}
                        onChange={(value) =>
                           handleOnChangeEvent(value, 'price')
                        }
                  ...
                  <div>
                     {product.assetsType === 'Finished Goods' ? (
                        <Checkbox
                           ...
                           onChange={(_, checked) =>
                              handleOnChangeEvent(checked ? 1 : 0, 'addParts')
                           }
                           ...
                           renderValue={(value, items) =>
                              items.map((item) => (
                                 <span
                                    ...
                                    <Badge
                                       content={quantities[item.value] || 1}>
                                       {item.label}
                                    </Badge>
                                 </span>
                              ))
