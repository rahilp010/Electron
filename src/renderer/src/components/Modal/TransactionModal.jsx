...
const TransactionModal = ({
   ...
   const getInitialTransaction = () => {
      if (isUpdateExpense && existingTransaction) {
         console.log(
            'Initializing with existing transaction:',
            existingTransaction
         );
         return {
            ...
            statusOfTransaction:
               existingTransaction.statusOfTransaction || 'pending',
   ...
   useEffect(() => {
      if (isUpdateExpense && existingTransaction?.id) {
         console.log(
            'Initializing transaction for update:',
            existingTransaction
         );
         setTransaction({
            clientId: existingTransaction.clientId || '',
   ...
   const handleSubmitTransaction = useCallback(
      async (e) => {
         ...
         try {
            ...
            if (!isUpdateExpense) {
               const response = await window.api.createTransaction(
                  transactionData
               );
               dispatch(setTransactions(response));
                  ...
                  <div className="grid grid-cols-2 gap-4 my-2">
                     <div>
                        ...
                        <SelectPicker
                           ...
                           onChange={(value) =>
                              handleOnChangeEvent(value, 'clientId')
                           }
                     ...
                     <div>
                        ...
                        <InputNumber
                           ...
                           onChange={(value) =>
                              handleOnChangeEvent(value, 'quantity')
                           }
                     ...
                     <div>
                        ...
                        <InputNumber
                           ...
                           onChange={(value) =>
                              handleOnChangeEvent(value, 'sellingPrice')
                           }
                           formatter={toThousands}
                           min={0}
                           name="sellingPrice"
                     ...
                     <Animation.Collapse
                        in={transaction.paymentType === 'partial'}>
                        <div>
                           <label
                              htmlFor="pending"
                              className="block text-sm mb-1 text-gray-600">
                           ...
                           <InputNumber
                              ...
                              formatter={toThousands}
                              onChange={(val) =>
                                 handleOnChangeEvent(val, 'pendingAmount')
                              }
                              id="pendingAmount"
                     ...
                     <Animation.Collapse
                        ...
                        <div>
                           ...
                           <InputNumber
                              ...
                              formatter={toThousands}
                              onChange={(val) =>
                                 handleOnChangeEvent(val, 'paidAmount')
                              }
                              id="paidAmount"
                              className="w-full border border-gray-300 rounded px-2 py-1.5 
                                               focus:outline-none focus:ring-2 focus:ring-blue-400 h-9"
